...
export let options = {
  stages: [
    { duration: '5s', target: 5 }, // 100 users for 1 minute
    { duration: '5s', target: 10 }, // stay at 100 users for 1 minute
    { duration: '5s', target: 5 }, // stay at 100 users for 1 minute
    { duration: '5s', target: 10 }, // ramp down to 0 users for 1 minute
  ],
  thresholds: {
