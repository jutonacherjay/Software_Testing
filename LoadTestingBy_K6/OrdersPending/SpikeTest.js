...
export let options = {
  stages: [
    { duration: '1m', target: 50 }, // 100 users for 1 minute
    { duration: '1m', target: 50 }, // stay at 100 users for 1 minute
    { duration: '1m', target: 100 }, // stay at 100 users for 1 minute
    { duration: '1m', target: 0 }, // ramp down to 0 users for 1 minute
  ],
  thresholds: {
